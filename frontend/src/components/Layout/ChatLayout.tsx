                ...
                <ResizablePanelGroup direction="horizontal" className="h-full w-full rounded-lg border">
                    ...
                    {!embedded && (isDesktop || isMobileMenuOpen) && (
                        <ResizablePanel
                            ...
                            className={cn(
                                ...
                                !isDesktop && "absolute inset-0 z-50 bg-background w-3/4 shadow-2xl"
                            )}
                    ...
                    <ResizablePanel defaultSize={100 - leftSize - (isRightCollapsed ? 0 : rightSize)} minSize={30}>
                        <div className="h-full flex flex-col bg-background relative">
                            {/* Chat Header */}
                            <div className="h-14 border-b flex items-center justify-between px-6 bg-background/80 backdrop-blur-md sticky top-0 z-10">
                                <div className="flex items-center gap-3">
                        ...
                        <>
                            ...
                            >
                                <div className="h-full flex flex-col">
                                    <div className="h-14 border-b flex items-center px-4 bg-background/50">
